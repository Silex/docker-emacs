...
- [`28.1`, `28`, `latest`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/Dockerfile)
- [`28.1-dev`, `28-dev`, `dev`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/dev/Dockerfile)
- [`28.1-ci`, `28-ci`, `ci`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/ci/Dockerfile)
- [`28.1-ci-cask`, `28-ci-cask`, `cask`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/ci/cask/Dockerfile)
- [`28.1-ci-eldev`, `28-ci-eldev`, `eldev`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/ci/eldev/Dockerfile)
- [`28.1-ci-keg`, `28-ci-keg`, `keg`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/ci/keg/Dockerfile)
- [`28.1-alpine`, `28-alpine`, `alpine`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/Dockerfile)
- [`28.1-alpine-dev`, `28-alpine-dev`, `alpine-dev`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/dev/Dockerfile)
- [`28.1-alpine-ci`, `28-alpine-ci`, `alpine-ci`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/ci/Dockerfile)
- [`28.1-alpine-ci-cask`, `28-alpine-ci-cask`, `alpine-ci-cask`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/ci/cask/Dockerfile)
- [`28.1-alpine-ci-eldev`, `28-alpine-ci-eldev`, `alpine-ci-eldev`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/ci/eldev/Dockerfile)
- [`28.1-alpine-ci-keg`, `28-alpine-ci-keg`, `alpine-ci-keg`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/ci/keg/Dockerfile)
- [`27.2`, `27`](https://github.com/Silex/docker-emacs/blob/master/27.2/debian/Dockerfile)
- [`27.2-dev`, `27-dev`](https://github.com/Silex/docker-emacs/blob/master/27.2/debian/dev/Dockerfile)
...
- [`27.2-alpine-dev`, `27-alpine-dev`](https://github.com/Silex/docker-emacs/blob/master/27.2/alpine/dev/Dockerfile)

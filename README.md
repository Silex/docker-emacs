...
- `26.1-alpine-dev`, `26-alpine-dev` [(26.1/alpine/3.7/Dockerfile)](https://github.com/silex/docker-emacs/blob/master/26.1/alpine/3.7/Dockerfile)
...
- `25.3-alpine-dev`, `25-alpine-dev`, `alpine-dev` [(25.3/alpine/3.7/Dockerfile)](https://github.com/silex/docker-emacs/blob/master/25.3/alpine/3.7/Dockerfile)

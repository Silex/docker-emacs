...
- [`27.1-alpine`, `27-alpine`](https://github.com/Silex/docker-emacs/blob/master/27.1/alpine/3.9/Dockerfile)
- [`27.1-alpine-dev`, `27-alpine-dev`](https://github.com/Silex/docker-emacs/blob/master/27.1/alpine/3.9/dev/Dockerfile)

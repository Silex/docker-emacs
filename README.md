...
- [`28.2-dev`, `28-dev`, `dev`](https://github.com/Silex/docker-emacs/blob/master/28.2/debian/dev/Dockerfile)
...
- [`28.2-alpine-dev`, `28-alpine-dev`, `alpine-dev`](https://github.com/Silex/docker-emacs/blob/master/28.2/alpine/dev/Dockerfile)
...
- [`28.1-dev`](https://github.com/Silex/docker-emacs/blob/master/28.1/debian/dev/Dockerfile)
...
- [`28.1-alpine-dev`](https://github.com/Silex/docker-emacs/blob/master/28.1/alpine/dev/Dockerfile)

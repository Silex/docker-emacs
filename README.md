...
- [`24.3-ci-eldev`](https://github.com/Silex/docker-emacs/blob/master/24.3/debian/ci/eldev/Dockerfile)
...
- [`24.2-ci-eldev`](https://github.com/Silex/docker-emacs/blob/master/24.2/debian/ci/eldev/Dockerfile)
...
- [`24.1-ci-eldev`](https://github.com/Silex/docker-emacs/blob/master/24.1/debian/ci/eldev/Dockerfile)
